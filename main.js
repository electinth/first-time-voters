...
//   .on("enter", function (e) {
//     console.log(e);
//     range_input.property("value", percents[0]);
//     sliderUpdate(percents[0]);
//   });

// const percents = [0, 1, 1, 25, 50, 100, 0, 0];
...
//     range_input.property("value", percents[e.index]);
//     sliderUpdate(percents[e.index]);
//   })
//   .onStepExit(function (e) {
//     console.log("exit " + e.index);
//     if (e.index > 0) {
//       range_input.property("value", percents[e.index - 1]);
//       sliderUpdate(percents[e.index - 1]);
//     }
//   });
